...
module.exports.createApplication = function(properties, serviceLocator, databaseAdaptor) {
	...
	app.configure(function() {
		...
		serviceLocator.bundled.forEachProperty('publicRoute', function(bundle, publicRoute) {
		...
		// Middleware
		serviceLocator.bundled.forEachProperty('middleware', function(bundle, middleware) {
